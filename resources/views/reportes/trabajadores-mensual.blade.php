...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            ...
            <h3 class="mb-0 d-inline">📊 Ganancias Trabajadores - MES</h3>
        </div>
        <div class="btn-group me-3" role="group">
            <a href="{{ route('reportes.trabajadores.excel?periodo=Mensual') }}" class="btn btn-success">
                📊 Excel
            </a>
            <a href="{{ route('reportes.trabajadores.pdf?periodo=Mensual') }}" class="btn btn-danger">
                📄 PDF
            </a>
        </div>
    ...
    <div class="card shadow-sm border-0 rounded-4">
        <div class="card-header bg-warning text-white">
            <h6 class="mb-0">Mes de {{ $periodo_mes->format('F Y') }}</h6>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr><td colspan="4" class="text-center py-4 text-muted">Sin servicios este mes</td></tr>
                        @endforelse
                    </tbody>
